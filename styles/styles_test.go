...
func TestSelectTheme(t *testing.T) {
	tests := []struct {
		...
		{name: "Select dark theme", theme: "dark", want: glamStyles.DarkStyleConfig, wantErr: false},
		{name: "Select light theme", theme: "light", want: glamStyles.LightStyleConfig, wantErr: false},
		{name: "Select ascii theme", theme: "ascii", want: glamStyles.ASCIIStyleConfig, wantErr: false},
		{name: "Select notty theme", theme: "notty", want: glamStyles.NoTTYStyleConfig, wantErr: false},
		{name: "Select theme with error", theme: "notty", want: glamStyles.DarkStyleConfig, wantErr: true},
	}
